...
;; Nix org-mode code block output support
(require 'ob)

(defun org-babel-execute:nix (body params)
  "Execute a block of Nix code with org-babel."
  (message "Executing Nix code block")
  (let ((tmp-file (org-babel-temp-file "nix-")))
    (with-temp-file tmp-file
      (insert body))
    (org-babel-eval (format "nix-instantiate --eval --strict %s" tmp-file) "")))
